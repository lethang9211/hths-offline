...
<a href="https://www.mediafire.com/file/2y7ibxi2249gcsl/hso.sql/file" src="https://github.com/Mad-Neko/Nro-Offline/blob/main/icon/sql.png" />
...
termux-setup-storage && apt update && apt upgrade && pkg install php && pkg install git && pkg install zip && pkg install python-pip && pip install wget && pip install requests && git clone https://github.com/lethang9211/hths_termux && cd hths_termux && python hso.py && python setup.py && python hths.py
